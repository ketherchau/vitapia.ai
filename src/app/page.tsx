    ...
    <main ref={container} className="relative min-h-[1000vh]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 md:px-12 md:py-6 bg-gradient-to-b from-[#0a0a0a]/80 to-transparent backdrop-blur-sm">
        <div className="flex items-center gap-3">
          <div className="relative w-12 h-12 overflow-hidden drop-shadow-[0_0_10px_rgba(0,255,133,0.3)]">
            ...
            <Image src="/logo-black.png" alt="Vitapia.ai Logo" fill className="object-contain" priority />
          </div>
          <span className="text-2xl font-bold tracking-tight text-white text-shadow-hard hidden md:block">Vitapia.ai</span>
        </div>
        <button 
      ...
      <div className="relative z-10 flex flex-col">
        ...
        <section className="h-screen flex flex-col items-center justify-center text-center px-4">
          ...
          >
            Replace slow surveys with high-fidelity digital twins of Hong Kong. 
        ...
        {isModalOpen && (
          ...
          >
            ...
            >
              ...
              <p className="text-zinc-400 mb-8">Enter your email to join the Vitapia.ai enterprise pilot waitlist.</p>
              
              <form onSubmit={(e) => { e.preventDefault(); setIsModalOpen(false); alert("Request sent!"); }} className="flex flex-col gap-4">
                <input 
                  type="email" 
                  required 
                  placeholder="name@company.com" 
                  className="w-full px-5 py-4 rounded-xl border border-zinc-800 bg-zinc-900 text-white placeholder:text-zinc-600 focus:outline-none focus:border-[#00E5FF] focus:ring-1 focus:ring-[#00E5FF] transition-all"
                />
                <button 
                  type="submit"
                  className="w-full px-5 py-4 rounded-xl bg-gradient-to-r from-[#00E5FF] to-[#00FF85] text-black font-bold text-lg hover:opacity-90 transition-opacity"
                >
                  Join Waitlist
                </button>
              </form>
